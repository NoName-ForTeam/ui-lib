...
/* @param {import('react-hook-form').Control<TFieldValues>} props.control - The control
 object from react-hook-form used to manage form state. */
export type FormTextAreaProps<TFieldValues extends FieldValues> = UseControllerProps<TFieldValues> &
  /* @param {Omit<TextAreaProps, 'onBlur' | 'onChange' | 'value'>} [props.textAreaProps] - Additional props
